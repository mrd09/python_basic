...
print("")
print("- Table 4: Docker Engine")
row_6 = '+ {:-^25} +'.format('')
print(row_6)
row_6_1 = '| {:<25} |'.format('Docker Engine')
print(row_6_1)
row_6 = '+ {:_^25} +'.format('','')
print(row_6)
row_6_1 = '| {:^25} |'.format('Client: docker CLI')
print(row_6_1)
row_6_1 = '| {:^25} |'.format('|REST API|')
print(row_6_1)
row_6_1 = '| {:^25} |'.format('Server: docker daemon')
print(row_6_1)
row_6 = '+ {:-^25} +'.format('')
print(row_6)

print("")
print("- Table 4: Docker Machine")
row_6 = '+ {:-^25} +'.format('')
print(row_6)
row_6_1 = '| {:<25} |'.format('Docker Machine')
print(row_6_1)
row_6 = '+ {:_^25} +'.format('','')
print(row_6)
row_6_1 = '| {:^25} |'.format('Client: docker-machine')
print(row_6_1)
row_6_1 = '| {:^25} |'.format('|Client: docker CLI|')
print(row_6_1)
row_6_1 = '| {:^25} |'.format('|REST API|')
